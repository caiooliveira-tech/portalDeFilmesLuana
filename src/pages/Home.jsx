...
function Home() {
    return ( 
        ...
        <Banner/>
        <Meio/>
        <div className='block  gap-4 p-5 '>
            {
                data.map( (artigo, index) => (
                    <div key={index} className='flex items-center'>
                    <div className='card pb-5 text-center' >
                        <h2 className='p-2 bg-marrom text-white'>{artigo.title}</h2> 
                        <img className="mb-2" src={artigo.image} alt={artigo.title} />
                    </div>
                        <article className='pl-10'>
                            <div className="flex items-center mb-4 pl-">
                                <img className="w-10 h-10 me-4 rounded-full" src={artigo.perfil} alt=""></img>
                                <div className="font-medium dark:text-white">
                                    <p>{artigo.pessoa}<time dateTime="2014-08-16 19:00" className="block text-sm text-gray-500 dark:text-gray-400">Joined on August 2014</time></p>
                                </div>
                            </div>
                            <div className="flex items-center mb-1 space-x-1 rtl:space-x-reverse">
                                ...
                                <h3 className="ms-2 text-sm font-semibold text-gray-900 dark:text-white">{artigo.msg}</h3>
                            </div>
                            ...
                            <p className="mb-2 text-gray-500 dark:text-gray-400">{artigo.text}</p>
