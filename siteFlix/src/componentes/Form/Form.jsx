        ...
        <section class="mb-12 mt-14">
          ...
          <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
              <div class="flex items-center lg:mb-0 mb-10">
                  <div class="">
                      <h2 class="text-gray-900 font-manrope text-4xl font-semibold leading-10 mb-9 lg:text-left text-center">Fale conosco!</h2>
                      <form action="">
                          <input type="text" class="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none py-2 px-4 mb-8" placeholder="Nome" />
                          ...
                          <textarea name="" id="text" class="w-full h-48 shadow-sm resize-none text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-2xl border border-gray-200 focus:outline-none px-4 py-4 mb-8" placeholder="Mensagem"></textarea>
                      <button class="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-marrom shadow transition-all duration-700 hover:bg-mClaro hover:text-marrom">Enviar</button>
                      </form>
                  </div>
              </div>
              <div class="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat bg-[url('../../../public/moviesCont.jpg')]">
                  <div class="">
                      <div class="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                          ...
                          <a href="javascript:;" class="flex items-center mb-6">
                              ...
                              <h5 class="text-black text-base font-normal leading-6 ml-5">4002-8922</h5>
                          </a>
                          <a href="javascript:;" class="flex items-center mb-6">
                              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <h5 class="text-black text-base font-normal leading-6 ml-5">LuFlix@gmail.com</h5>
                          </a>
                          <a href="javascript:;" class="flex items-center mb-6">
                              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <h5 class="text-black text-base font-normal leading-6 ml-5">Casa engraçada, rua dos loucos N°0</h5>
                          </a>
