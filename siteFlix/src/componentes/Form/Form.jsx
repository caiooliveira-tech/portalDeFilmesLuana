        ...
        <section className="mb-12 mt-14">
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
              <div className="flex items-center lg:mb-0 mb-10">
                  <div className="">
                      <h2 className="text-marrom font-manrope text-4xl font-semibold leading-10 mb-9 lg:text-left text-center">Fale conosco!</h2>
                      <form action="">
                          <input type="text" className="w-full h-14 shadow-sm text-white bg-mClaro placeholder-white text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none py-2 px-4 mb-8" placeholder="Nome" />
                          <input type="email" className="w-full h-14 shadow-sm text-white bg-mClaro placeholder-white text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none py-2 px-4 mb-8" placeholder="Email"/>
                          <textarea name="" id="text" className="w-full h-48 shadow-sm resize-none text-white bg-mClaro placeholder-white text-lg font-normal leading-7 rounded-2xl border border-gray-200 focus:outline-none px-4 py-4 mb-8" placeholder="Mensagem"></textarea>
                      <button className="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-marrom shadow transition-all duration-700 hover:bg-mClaro hover:text-marrom">Enviar</button>
                      </form>
                  </div>
              </div>
                  ...
                  <div className="">
                      <div className="lg:w-96 w-auto h-auto bg-mClaro shadow-xl lg:p-6 p-4">
                          ...
                          <a href="javascript:;" className="flex items-center mb-6">
                              ...
                              <h5 className="text-white text-base font-normal leading-6 ml-5">4002-8922</h5>
                          </a>
                          <a href="javascript:;" className="flex items-center mb-6">
                              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <h5 className="text-white text-base font-normal leading-6 ml-5">LuFlix@gmail.com</h5>
                          </a>
                          <a href="javascript:;" className="flex items-center mb-6">
                              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M25 12.9169C25 17.716 21.1939 21.5832 18.2779 24.9828C16.8385 26.6609 16.1188 27.5 15 27.5C13.8812 27.5 13.1615 26.6609 11.7221 24.9828C8.80612 21.5832 5 17.716 5 12.9169C5 10.1542 6.05357 7.5046 7.92893 5.55105C9.8043 3.59749 12.3478 2.5 15 2.5C17.6522 2.5 20.1957 3.59749 22.0711 5.55105C23.9464 7.5046 25 10.1542 25 12.9169Z" stroke="#000000" strokeWidth="2"></path>
                                  <path d="M17.5 11.6148C17.5 13.0531 16.3807 14.219 15 14.219C13.6193 14.219 12.5 13.0531 12.5 11.6148C12.5 10.1765 13.6193 9.01058 15 9.01058C16.3807 9.01058 17.5 10.1765 17.5 11.6148Z" stroke="#000000" strokeWidth="2"></path>
                              </svg>
                              <h5 className="text-white text-base font-normal leading-6 ml-5">Casa engraçada, rua dos loucos N°0</h5>
                          </a>
                          <div className="flex items-center justify-center border-t border-marrom gray-100 pt-6">
